...
namespace
{
    ...
    void setDefaults()
    {
        ...
        settings.displayTimeoutEnabled = DISPLAY_TIMEOUT_ENABLED_DEFAULT;
        settings.displayActiveMode = DISPLAY_ACTIVE_MODE_DEFAULT;
    ...
    void sanitize()
    {
        ...
        settings.displayTimeoutEnabled = settings.displayTimeoutEnabled ? 1 : 0;
        if (settings.displayActiveMode > DISPLAY_ACTIVE_MODE_USB_MOUNTED_DEFAULT)
        {
            settings.displayActiveMode = DISPLAY_ACTIVE_MODE_DEFAULT;
        }
        settings.displayActiveStartMinute = constrain(settings.displayActiveStartMinute, 0, 1439);
        settings.displayActiveEndMinute = constrain(settings.displayActiveEndMinute, 0, 1439);
        if (settings.displayDesign >= DISPLAY_HOME_DESIGN_COUNT_DEFAULT)
        {
            settings.displayDesign = DISPLAY_HOME_DESIGN_DEFAULT;
        }
